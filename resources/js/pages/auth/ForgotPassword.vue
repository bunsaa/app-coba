...
const submit = () => {
    form.post('/reset-password-default', {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head title="Lupa Password - MUTU RSUD" />
            ...
            <div class="rounded-2xl bg-white p-8 shadow-lg">
                ...
                <div class="mb-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Masukkan NIP Anda untuk mereset password
                    </p>
                </div>

                <!-- Success Message -->
                <div
                    v-if="status === 'reset_success'"
                    class="mb-6 rounded-lg border border-green-200 bg-green-50 p-4"
                >
                    <div class="flex items-start gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-green-600">
                                Silakan login dan Anda akan diminta untuk mengganti password baru.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 text-center">
                    <Link
                        :href="login()"
                        class="inline-flex items-center gap-1.5 text-sm font-medium text-blue-600 transition-colors hover:text-blue-800"
                    >
